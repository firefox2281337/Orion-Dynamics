...
from web.templates.nexus.autoreg.logic.handler_stubs import (
    ...
    set_subdivision, final_format_osago, set_region_and_filial_osago_kasko, fix_auto, create_cars, create_short_links
)
    ...
    def run(self):
        ...
        try:
            ...
            result_data = result_data.with_columns([
                ...
                set_departament(departament="Телемаркетинг УДП")])
            ...
            contracts = create_contracts_file_kasko_osago(processed_data, base_type)
            ...
            processed_data = processed_data.drop("Марка", "Модель", "Год выпуска", "VIN", "Номер проекта", "Программа страхования", "literal")
