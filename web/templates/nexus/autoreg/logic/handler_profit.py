# web/templates/nexus/autoreg/handler_profit.py
"""
...
from web.templates.nexus.autoreg.logic.handler_stubs import (
    ...
    set_correct_product_ipo, final_format_ipo, create_person_file, set_lead_company_by_employee,
    create_contracts_file, create_linked_leads_file, set_lead_id_by_employee, save_to_excel
)
...
class RegistryProcessor:
    ...
    def run(self):
        ...
        try:
            ...
            result_data = result_data.with_columns(set_lead_company_by_employee())
            ...
            processed_data = processed_data.with_columns(pl.lit("ПРОФИТ: Нефинансовые посредники и банки").alias("Филиал ВСК"), pl.lit("Москва").alias("Регион"))
            ...
            zip_filename = f"{self.number}_{base_type}_МСК_пролонгация.zip"
