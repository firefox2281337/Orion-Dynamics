    ...
    def run(self):
        ...
        try:
            ...
            result_data = result_data.with_columns([
                ...
                set_links_osago(base_type), pl.lit("1.2 Пилот КЗ Хабаровского филиала 30").alias("Кампания")])
            ...
            contracts = create_contracts_osago_kz_file(processed_data)
